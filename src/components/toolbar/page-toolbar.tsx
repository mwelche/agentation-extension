...
// createPortal removed — in the extension, the toolbar renders directly
// into the shadow root container (no portal needed).

import {
  AnnotationPopupCSS,
  AnnotationPopupCSSHandle,
} from "../annotation-popup";
import {
  IconListSparkle,
  IconGear,
  IconCopyAnimated,
...
const [settings, setSettings] = useState<ToolbarSettings>(() => {
  ...
  // In the Chrome extension, React detection examines the host page's DOM.
  // Treat it as always enabled — the detection functions handle prod gracefully.
